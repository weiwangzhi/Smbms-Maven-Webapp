...
public class SmbmsBill implements java.io.Serializable {
	...
	public SmbmsBill(Long id, String billCode, String productName, String productDesc, String productUnit,
			Double productCount, Double totalPrice, Integer isPayment, Long createdBy, Timestamp creationDate,
			Long modifyBy, Timestamp modifyDate, Integer providerId, String providername) {
		super();
		this.id = id;
