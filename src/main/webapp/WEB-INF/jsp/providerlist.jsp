...
<div class="right">
	...
	<div class="search">
		<form action="initProviderList.do" method="post">
			<input type="hidden" /> <span>供应商编码：</span> <input name="proCode"
				class="input-text" type="text" value="${proCode }"> <span>供应商名称：</span>
			<input name="proName" class="input-text" type="text"
				value="${proName }"> <input type="hidden" name="pageIndex"
				value="1" /> <input value="查 询" type="submit" id="searchbutton">
			<a href="provideradd.do">添加供应商</a>
		</form>
	</div>
	<!--供应商-->
