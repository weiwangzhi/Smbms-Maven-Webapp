...
<div class="right">
	...
	<div class="search">
		<form action="initUserList.do" method="post">
			<input type="hidden" /> <span>用户名：</span> <input name="queryname"
				class="input-text" type="text" value="${queryUserName }"> <span>用户角色：</span>
